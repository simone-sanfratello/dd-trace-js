        ...
        describe('without configuration', () => {
          ...
          it('should do automatic instrumentation', done => {
            agent.use(traces => {
              ...
              expect(spans[0].meta).to.have.property('moleculer.service', 'math')
              expect(spans[0].meta).to.have.property('moleculer.action', 'math.add')
              expect(spans[0].meta).to.have.property('moleculer.request_id')
              expect(spans[0].meta).to.have.property('moleculer.node_id')
              ...
              expect(spans[1].meta).to.have.property('moleculer.service', 'math')
              expect(spans[1].meta).to.have.property('moleculer.action', 'math.numerify')
              expect(spans[1].meta).to.have.property('moleculer.request_id')
              expect(spans[1].meta).to.have.property('moleculer.node_id')
            }).then(done, done)
